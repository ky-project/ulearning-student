...
export const GET_EXCELLENT_EXPERIMENT_RESULT_LIST = '/student/experimentResult/pageList' // 查询优秀实验结果
export const GET_EXCELLENT_EXPERIMENT_RESULT = '/student/experimentResult/getSharedById' // 根据实验结果id查询优秀实验结果
// 通告管理
